  ...
  return (
    <div className='about-page'>
      ...
      <div className='white-bg'>
        ...
        <br /><br />The research focused on understanding students’ relationship to food, both at home, on campus and around their neighbourhoods. We asked students about how food insecurity affected their friendships, peer and personal relationships, and their studies. We also found out about the interconnectedness of students’ food struggles with other areas of their lives including housing, finances and paid work. Although the research was planned prior to the pandemic, we quickly found that COVID-19 was a significant contributor to many students’ food woes, especially international students. Students employed a range of resourceful and creative tactics to cope with their everyday struggle. 
        <br /><br />Finally, we made sure to ask students about how they thought we might begin to tackle the problem. These ideas formed the basis of our toolkit. 
        </p>
      </div>
    </div>
  )
